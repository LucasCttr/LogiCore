        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxWeightCapacity = table.Column<decimal>(type: "numeric", nullable: false),
                    MaxVolumeCapacity = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleMaxWeightCapacity = table.Column<decimal>(type: "numeric", nullable: false),
                    VehicleMaxVolumeCapacity = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipientProvince = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    RecipientPostalCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    RecipientDni = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    RecipientFloorApartment = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ...
                    LengthCm = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
