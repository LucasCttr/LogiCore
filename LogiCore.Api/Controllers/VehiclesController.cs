...
public class VehiclesController : ControllerBase
{
    ...
    // GET: api/vehicles
    [HttpGet]
    public async Task<ActionResult<LogiCore.Application.Common.Models.Result<IEnumerable<VehicleDto>>>> GetAll()
    {
    ...
    // GET: api/vehicles/{id}
    [HttpGet("{id:guid}")]
    public async Task<ActionResult<LogiCore.Application.Common.Models.Result<VehicleDto>>> GetById(Guid id)
    {
    ...
    // POST: api/vehicles
    [HttpPost]
    public async Task<ActionResult<LogiCore.Application.Common.Models.Result<VehicleDto>>> Create([FromBody] CreateVehicleDto request)
    {
    ...
    // PUT: api/vehicles/{id}
    [HttpPut("{id:guid}")]
    public async Task<ActionResult<LogiCore.Application.Common.Models.Result<VehicleDto>>> Update(Guid id, [FromBody] UpdateVehicleDto request)
    {
    ...
    [HttpDelete("{id:guid}")]
    public async Task<ActionResult<LogiCore.Application.Common.Models.Result<bool>>> Delete(Guid id)
    {
    ...
    public async Task<ActionResult<LogiCore.Application.Common.Models.Result<VehicleDto>>> UpdateStatus(Guid id, [FromBody] UpdateVehicleStatusDto request)
    {
